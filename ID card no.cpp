Exercise 2
Write a program that reads an identification number which could be an ID card number in the following format: XXXXX-XXXXXXX-X
Using members of the string class separate the different fields of the identification number and display each field.
Program:
#include <iostream>
#include <string>
using namespace std;
